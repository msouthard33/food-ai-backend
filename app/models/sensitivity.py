...
class UserSensitivityProfile(Base):
    ...
    __table_args__ = (
        UniqueConstraint("user_id", "component_type", name="uq_user_sensitivity_profiles_user_component"),
    )
...
class FoodCombinedRating(Base):
    ...
    contributing_components: Mapped[dict] = mapped_column(JSONB, nullable=False, server_default="[]")
