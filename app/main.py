...
from app.routers import admin, barcode, export, fhir, foods, health, insights, meals, medications, protocols, reports, symptoms, users
...
async def validation_exception_handler(
    ...
    # jsonable_encoder strips non-serialisable objects (e.g. the original
    # ValueError a field_validator raises lands in each error's `ctx`).
    return JSONResponse(
